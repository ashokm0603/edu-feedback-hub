...
const FirstYear_1_1_AIML = () => {
  ...
  const labsubjects = ["CP LAB", "BEEE LAB", "EG LAB", "PHYSICS LAB"];
  ...
  const handleSubmit = async (e) => {
    ...
    setSuccessMessage("");
        ...
        try {
          const response = await fetch("http://localhost:5000/api/feedback_1_1_aiml", {
            method: "POST",
            headers: {
  ...
  return (
    <div className="form-container">
      ...
      <div className="form-header2">
        <p>
          Dear 1-1 CSE AIML Students, Please provide your Feedback by giving
      ...
      <form onSubmit={handleSubmit}>
        ...
        <select id="sect" value={section} onChange={(e) => setSection(e.target.value)}>
          ...
          <option value="AI-Boys">AIML-Boys</option>
        </select>
...
export default FirstYear_1_1_AIML;
