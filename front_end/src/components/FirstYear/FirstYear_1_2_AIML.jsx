...
const FirstYear_1_2_AIML = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setSuccessMessage("");
        ...
        try {
          const response = await fetch("http://localhost:5000/api/feedback_1_2_aiml", {
            method: "POST",
            headers: {
  ...
  return (
    <div className="form-container">
      ...
      <div className="form-header2">
        <p>
          Dear 1-2 CSE AIML Students, Please provide your Feedback by giving
      ...
      <label htmlFor="sect">Choose Section</label>
        <select id="sect" value={section} onChange={(e) => setSection(e.target.value)}>
          ...
          <option value="AIML-BOYS">AIML-BOYS</option>
          <option value="AIML-GIRLS">AIML-GIRLS</option>
        </select>
...
export default FirstYear_1_2_AIML;
