...
const FirstYear_1_2_CSE = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("http://localhost:5000/api/feedback_1_2_cse", {
        method: "POST",
        headers: {
  ...
  return (
    <div className="form-container">
      ...
      <div className="form-header2">
        <p>
          Dear 1-2 CSE Students, Please provide your Feedback by giving
      ...
      <form onSubmit={handleSubmit}>
       ...
       <label htmlFor="sect">Choose Section</label>
        ...
        <option value="">Select Section</option>
         <option value="CSE-A,DS(Girls)">CSE-A,DS(Girls)</option>
...
export default FirstYear_1_2_CSE;
