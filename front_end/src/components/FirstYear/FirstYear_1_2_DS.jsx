...
const FirstYear_1_2_DS = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("http://localhost:5000/api/feedback_1_2_ds", {
        method: "POST",
        headers: {
  ...
  return (
    <div className="form-container">
      ...
      <div className="form-header2">
        <p>
          Dear 1-2 CSE DS Students, Please provide your Feedback by giving
...
export default FirstYear_1_2_DS;
