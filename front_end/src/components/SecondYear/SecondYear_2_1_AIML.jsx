...
const SecondYear_2_1_AIML = () => {
  ...
  const labsubjects = ["DBMS LAB", "JAVA LAB"];
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("http://localhost:5000/api/feedback_2_1_aiml", {
        method: "POST",
        headers: {
  ...
  return (
    <div className="form-container">
      ...
      <div className="form-header2">
        <p>
          Dear 2-1 CSM Students, Please provide your Feedback by giving
...
export default SecondYear_2_1_AIML;
