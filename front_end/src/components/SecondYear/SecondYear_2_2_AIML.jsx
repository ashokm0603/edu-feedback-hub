        ...
        return (
          ...
          >
            <svg
              ...
              style={starValue <= rating ? { boxShadow: "5px 5px 5px black" } : {}}
            >
...
const SecondYear_2_2_AIML = () => {
  const subjects = ["P&S", "OT", "AI", "ML", "ADS", "ML LAB", "ADS LAB", "FSD-1/SOC-2 LAB", "DT&I LAB"];
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("http://localhost:5000/api/feedback_2_2_aiml", {
        method: "POST",
        headers: {
  ...
  return (
    <div className="form-container">
      ...
      <div className="form-header2">
        <p>
          Dear 2-2 CSE AIML Students, Please provide your Feedback by giving a rating (on a scale of Excellent to Poor) for each Subject.
        </p>
        <ul>
          <li>
            <span>*Note:</span> The Information Provided by you will be <span>Confidential</span>.
          </li>
        </ul>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="overall-rating">
          ...
          <div className="rating-scale">
            <StarRating rating={overallRating} setRating={setOverallRating} maxStars={5} />
          </div>
        </div>
...
export default SecondYear_2_2_AIML;
