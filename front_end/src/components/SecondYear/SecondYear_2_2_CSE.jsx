...
const SecondYear_2_2_CSE = () => {
  const subjects = ["P&S", "MEFA", "SE", "OS", "ADS", "ADS LAB", "OS LAB", "FSD-1/SOC-2 LAB", "DT&I LAB"];
  ...
  const handleSubmit = async (e) => {
    ...
    setSuccessMessage("");
        ...
        try {
          const response = await fetch("http://localhost:5000/api/feedback_2_2_cse", {
            method: "POST",
            headers: {
  ...
  return (
    <div className="form-container">
      ...
      <div className="form-header2">
        <p>Dear 2-2 CSE Students, Please provide your feedback by giving a rating (on a scale of Excellent to Poor) for each subject.</p>
        <ul>
          <li>
...
export default SecondYear_2_2_CSE;
