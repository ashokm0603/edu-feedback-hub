...
const SecondYear_2_2_DS = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setSuccessMessage("");
        ...
        try {
          const response = await fetch("http://localhost:5000/api/feedback_2_2_ds", {
            method: "POST",
            headers: {
  ...
  return (
    <div className="form-container">
      ...
      <div className="form-header2">
        <p>
          Dear 2-2 CSE DS Students, Please provide your Feedback by giving
...
export default SecondYear_2_2_DS;
