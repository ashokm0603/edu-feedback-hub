...
const SecondYear_2_2_ECE = () => {
  const subjects = ["MEFA", "LCS", "EMWTL", "ECA", "AC", "SS LAB", "ECA LAB"];
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("http://localhost:5000/api/feedback_2_2_ece", {
        method: "POST",
        headers: {
  ...
  return (
    <div className="form-container">
      ...
      <div className="form-header2">
        <p>
          Dear 2-2 ECE & EVT Students, Please provide your Feedback by giving
...
export default SecondYear_2_2_ECE;
