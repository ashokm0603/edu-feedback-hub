...
const ThirdYear_3_2_DS = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("http://localhost:5000/api/feedback_3_2_ds", {
        method: "POST",
        headers: {
  ...
  return (
    <div className="form-container">
      ...
      <div className="form-header2">
        <p>
          Dear 3-2 CSD Students, Please provide your Feedback by giving
...
export default ThirdYear_3_2_DS;
